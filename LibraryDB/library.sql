...
DEADLINE VARCHAR2(10) DEFAULT TO_CHAR(SYSDATE+7, 'YYYY-MM-DD') NOT NULL ,
...
ALTER TABLE SCOTT.MEMBER MODIFY ID NUMBER(8) DEFAULT SCOTT.MEMBER_SEQ.NEXTVAL;

ALTER TABLE SCOTT.BOOK MODIFY ID NUMBER(8) DEFAULT SCOTT.BOOK_SEQ.NEXTVAL;

ALTER TABLE SCOTT.BOOKLOAN MODIFY ID NUMBER(8) DEFAULT SCOTT.BOOKLOAN_SEQ.NEXTVAL;
...
INSERT INTO BOOK(TITLE,PUBLISHDATE) VALUES('백두산','20020202');
INSERT INTO BOOK(TITLE,PUBLISHDATE) VALUES('어린왕자','20120518');
INSERT INTO BOOK(TITLE,PUBLISHDATE) VALUES('그리고 아무도 없었다','20051121');
COMMIT; -- 데이터 삽입을 위해 COMMIT
